//
//  UserFollowViewCell.swift
//  SimyaStagram
//
//  Created by Nizamet Özkan on 11.02.2021.
//
...
class UserFollowViewCell: UITableViewCell {
    static let identifier = "UserFollowViewCell"
